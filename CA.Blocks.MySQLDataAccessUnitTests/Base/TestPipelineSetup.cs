...
{
    [CollectionDefinition("MySQLDbTypeTests")]
    public class MySQLDbTypeTestsCollection : ICollectionFixture<TestPipelineSetup> { }
...

    {
        ...
        {
            _appHost = await DistributedApplicationTestingBuilder.CreateAsync<Projects.CA_Blocks_MySqlAppHost>(CancellationToken);

...
namespace CA.Blocks.SqliteDataAccess.Adapters
{
    // Here we have stubbed an implementation for the DbDataAdapter for Sqlite. The code core blocks will need to restructure to not use the DbDataAdapter as it is been phased out.

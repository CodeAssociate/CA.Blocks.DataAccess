...
{
    // Here we have stubbed an implmentation for the DbDataAdapter for Sqllite. The code core blocks will need to restructure to not use the DbDataAdapter as it is been phased out.
